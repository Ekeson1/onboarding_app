...
import 'package:flutter_movie_app/description.dart';
import 'package:flutter_movie_app/utils/text.dart';

class TrendindingMovies extends StatelessWidget {
  final List trending;

  const TrendindingMovies({Key? key, required this.trending}) : super(key: key);
